<template>
    <div class="classnav">
        ...
        <GoodsListNew :goodslistnew="GoodStore.search.data.result" :searchstr="GoodStore.searchZhi" v-if="GoodStore.searchZhuang"></GoodsListNew>
    </div>
</template>
...
export default {
    ...
    watch:{
        active(newstr){
            ...
            window.sessionStorage.classtitle=newstr 
        }
    },
    mounted(){
        this.searchGo({
        ...
        this.active = sessionStorage.classtitle*1
    }
